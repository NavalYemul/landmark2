...
empdf.withColumn("ingestion_date",current_timestamp())\
    .withColumn("diff",date_diff("ingestion_date","date")).display()

# COMMAND ----------

df2=empdf.withColumn("new_Date",date_format("date","dd MMMM yyyy"))

# COMMAND ----------

empdf.withColumn("date",to_date("date")).printSchema()

# COMMAND ----------

data=([(1,20240410),(2,20240409)])
schema="id int, date int"
...
df.withColumn("new_date",date_format("date","yyyy-MM-dd")).display()
